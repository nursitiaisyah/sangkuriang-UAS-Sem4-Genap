							...
							<table class="table table-sm table-borderless">
								...
								<tr>
									...
									<tr>
										...
										<td>Rp. <?=number_format($byKel,0,',',',');?>,</td>
									</tr>
									<tr>
						...
						<nav>
							<ul class="pagination">
								...
								Halaman
									...
									<a class="page-link" href="<?php
										if($hal <= 1) echo '#'; else echo "?hal" . $sblm; ?>">
									...
									<?php
										...
										<?php for ($K = $Aw; $K <= $Ak; $K++) : ?>
											<li class="page-item <?php if ($hal == $K) echo 'active'; ?>">
												<a class="page-link" href="frmawal.php?hal=<?=$K;?>">
												<?=$K;?>
											</a>
										</li>
										<?php endfor;?>
							...
							<?php
									$st = "SELECT t_guru,nama,ID,aktif,jenis
											FROM t_guri INNER JOIN t_guru ON t_guri.id_Guru = t_guru.id 
												LEFT JOIN t_gunor ON t_gunor.id_guru = t_guru.ID 
												WHERE id_tari = '$kdTari'";
