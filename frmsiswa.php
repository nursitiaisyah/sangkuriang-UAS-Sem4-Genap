                ...
                <div class="container-fluid px-4">
                            ...
                            <tbody>
                                <?php foreach ($rows as $data) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button class="btn py-0" name="btnSiswaL" value="<?= $data['ID']; ?>">
                                                <i class="fas fa-eye"></i> Lihat
                                            </button>
                                            <button class="btn py-0" name="btnSiswaU" value="<?= $data['ID']; ?>">
                                                <i class="fas fa-edit"></i> Ubah
                                            </button>
                                            <button class="btn py-0" name="btnSiswaH" value="<?= $data['ID']; ?>">
                    ...
                    <div class="row">
                        <div class="col">
                            <nav>
                                <ul class="pagination">
                                    <div style="margin-top: 0.44rem; margin-right:0.44rem;">Halaman</div>
                                    <li class="page-item <?php if ($hal <= 1) echo 'disabled'; ?>">
                                        <a class="page-link" href="<?php if ($hal <= 1) echo '#'; else echo "?hal=" . $sblm; ?>">
                                    ...
                                    <li class="page-item <?php if ($hal >= $totHal) echo 'disabled'; ?>">
                                        <a class="page-link" href="<?php if ($hal > $totHal) echo '#'; else echo "?hal=" . $stlh; ?>">
                        ...
                        <div class="col-3">
                            <form method="post" action="">
                                <div class="input-group">
                                    <input class="form-control" name="txtCari" type="text" placeholder="Nama...">
