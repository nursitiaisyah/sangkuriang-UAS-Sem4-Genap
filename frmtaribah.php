				...
				<div class="container-fluid px-4">
					...
					<form method="post" action="taribahin.php">
						...
						<div class="form-group row">
							...
							<div class="col-3">
								<input class="form-control" type="text" name="txtNama" value="<?=$_SESSION['nama'];?>"autofocus>
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-2">
								<select class="form-control" name="cbbJenis">
									<option <?php if ($_SESSION['jenis']=="D") echo "selected='selected'";?> value="D">Daerah
										
									</option>
									<option <?php if ($_SESSION['jenis']=="M") echo "selected='selected'";?> value="M">Modern
						...
						<div class="form-group row">
							...
							<div class="col-1">
								<input class="form-control" type="text" name="txtLama" 
								value="<?=$_SESSION['lama'];?>">
						</div>
					...
					<div class="form-group row">
						...
						<div class="col-2">
							<input  class="form-control" type="text" name="txtGuru" value="<?php
					...
					<div class="form-group row">
						...
						<div class="col-2">
							<?php if ($_SESSION['nGuru'] < 1) :?>
								<input class="form-control" type="text" name="cbbAktif" value="<?php
