    ...
    <div class="sb-sidenav-menu">
        <?php if (isset($_SESSION['namaUser'])) : ?>
            ...
            <!---------------------------
                        SISWA
            ----------------------------->
            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#mnuSiswa"
            ...
            <!-----------------------
                    Pengajar
            ------------------------->
            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#mnuGuru"
            ...
            <!-----------------------
                    Latihan
            ------------------------->
            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#mnuLatihan"
            ...
            <div class="collapse" id="mnuLatihan" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionLatihan">
                    <a class="nav-link pt-0"
                        href="<?php if ($idMenu == 11 ) echo "#"; else echo "frmtari.php"; ?>">Daftar Tarian</a>
                </nav>
            </div>
