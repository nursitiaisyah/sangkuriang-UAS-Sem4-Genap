...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <form method="post" action="gunorbahin.php">
                        ...
                        <div class="form-group row">
                            <label for="txtIdxHR" class="col-2 col-form-label">Index Honor</label>
                            <div class="col-2">
            ...
            <footer class="py4 bg-light mt-auto">
                <div class="container-fluid- px-4">
                    <div class="d-flex align-items-center justify-content-beetween small">
