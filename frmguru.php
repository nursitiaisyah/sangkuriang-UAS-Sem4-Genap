...
<body class="sb-nav-fixed">
                    ...
                    <form method="post" action="guruaksi.php">
                                ...
                                <tr> 
                                    <td colspan="7" class="text-end">
                                        <a href="frmgurutam.php" class="btn btn-sm btn-primary">
                                            <i class="fas fa-plus"></i> Pengajar Baru</a>
                                    </td>
                                </tr>
                            <tr> 
                        ...
                        <tbody>
                            ...
                            <tr> 
                                ...
                                <?php if ($data['aktif'] == "Y") echo "Ya"; else echo "Tidak"; ?>
                            </td>
                            <td class="text-center">
                                <button class="btn py-0" name="btnGuruL"
                                value="<?=$data['ID'];?>"><i class="fas fa-eye"></i> Lihat
                            </button>
                            <button class="btn py-0" name="btnGuruU"
                                value="<?=$data['ID'];?>"><i class="fas fa-edit"></i> Ubah
                            </button>
                            <button class="btn py-0" name="btnGuruH"
                                value="<?=$data['ID'];?>"><i class="fas fa-trash-alt"></i>Hapus
                            </button>
                        </td>
                    </tr>
                <?php endwhile;?>
    ...
    <script src="alat2/js/bootstrap.bundle.min.js"></script>
